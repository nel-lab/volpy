...
dt = ['neurons','neurons_calcium', 'neurons_calcium_corr'][2]
...
for d in random.sample(dataset_dicts, 2):
    ...
    visualizer = Visualizer(img[:, :, ::-1], metadata=neurons_metadata, scale=1)
